            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h1 className="text-3xl font-bold text-[#00AC0B]">AI Assistants</h1>
                    </div>
                                ...
                                <div className="space-y-2">
                                    {assistantsWithLeads.map((assistant) => (
                                        <button
                                            ...
                                            className={`w-full text-left p-3 rounded-lg transition ${selectedAssistant === assistant._id
                                                ? "bg-[#EEFFEF] border border-[#00AC0B]"
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="bg-white rounded-2xl shadow p-8">
                                            <div className="flex items-start justify-between mb-6">
                                                ...
                                                <div className="p-3 bg-[#EEFFEF] rounded-full">
                                                    <Bot className="w-6 h-6 text-[#00AC0B]" />
                                                </div>
                                            </div>
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                                ...
                                                {/* Assigned Projects */}
                                                <div className="bg-linear-to-br from-[#FFF8E8] to-[#FFF8E8] p-4 rounded-lg">
                                                    <p className="text-gray-600 text-sm font-medium">
                                                        Projects
                                                    </p>
                                                    <p className="text-3xl font-bold text-[#E19E00] mt-2">
                                                        {selected.projects.length}
                                                    </p>
                                                </div>

                                                {/* Active Leads */}
                                                <div className="bg-linear-to-br from-[#EEFFEF] to-[#E0FFE0] p-4 rounded-lg">
                                                    <p className="text-gray-600 text-sm font-medium">
                                                        Hot Leads
                                                    </p>
                                                    <p className="text-3xl font-bold text-[#00AC0B] mt-2">
                                                        {
                                        ...
                                        {selected.projects.length > 0 && (
                                            <div className="bg-white rounded-2xl shadow p-8">
                                                <h3 className="text-lg font-bold text-[#00AC0B] mb-6 flex items-center gap-2">
                                                    <Briefcase className="w-5 h-5 text-[#00AC0B]" />
                                                    Assigned Projects
                                                </h3>
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                                    {selected.projects.map((project) => {
                                                        ...
                                                        return (
                                                            <div
                                                                key={project}
                                                                className="bg-[#EEFFEF] border border-[#00AC0B] rounded-xl p-4
          flex flex-col justify-center items-start 
          h-28 w-full"
                                                            >
                                                                <p className="text-xl font-semibold text-[#00AC0B]">
                                                                    {capitalizeFirst(project)}
                                                                </p>

                                                                <p className="text-sm font-medium text-[#00AC0B] mt-1">
                                                        ...
                                                        <tbody>
                                                            {selected.leads.map((lead) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <td className="py-3 px-4 text-sm">
                                                                        <span
                                                                            className={`px-2 py-1 rounded text-xs font-medium ${lead.lead_type === "hot"
                                                                    ...
                                                                    <td className="py-3 px-4 text-sm">
                                                                        <span
                                                                            className={`px-2 py-1 rounded text-xs font-medium ${lead.call_status === "connected"
